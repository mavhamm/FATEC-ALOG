/*	1º trabalho de ALOG | 17/05/2019

	Saque com notas de 50 e 20 reais sem usar estrutura de repetição (while)
	Algoritmo  de saques válidos: Fernando
...
int main () {
	...
	// pedir o valor de saque até que ele seja válido, ie, flag = 0
	do {
		scanf("%d", &saque);
